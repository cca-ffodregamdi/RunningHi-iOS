...
public enum FeedService{
    ...
    case writeComment(commentModel: WriteCommentReqesutModel)
    case makeBookmark(post: BookmarkRequestModel)
    case deleteBookmark(postId: Int)
    case deleteComment(postId: Int)
    case reportComment(reportCommentModel: ReportCommentRequestModel)
    case deletePost(postId: Int)
    case editPost(postId: Int, editPostModel: EditFeedRequestModel)
    case likePost(likePost: FeedLikeRequestModel)
    case unLikePost(postId: Int)
    case editComment(commentId: Int, editCommentModel: EditCommentRequestModel)
    ...
    case editFeed(postNo: Int, feedData: EditFeedRequestModel)
